...
var pool = mysql.createPool({
  connectionLimit : 10,
  host: process.env.FENCE_MICROSERVICE_DB_HOST,
  user: process.env.FENCE_MICROSERVICE_DB_USER,
  password: process.env.FENCE_MICROSERVICE_DB_PASSWORD,
  database: process.env.FENCE_MICROSERVICE_DB_NAME
});
